...
- [ ] I have read and followed the [Contributing Guidelines](https://github.com/apilsamrat/MaterialYouNewTab/blob/main/CONTRIBUTING.md).
...
- [ ] I have updated the [CHANGELOG.md](https://github.com/apilsamrat/MaterialYouNewTab/blob/main/CHANGELOG.md) under the appropriate categories with all my changes in this PR.
