...
const fa = {
    ...
    updateFirefoxHomepageInfo:
        'برای تغییر صفحه اصلی خود مانند برگه جدید، از <a href="https://github.com/apilsamrat/MaterialYouNewTab#-firefox" target="_blank">این پیوند</a> بازدید کرده و دستورالعمل‌ها را دنبال کنید.',
